...
Partial Public Class dbventasDataSet2
    ...
    Partial Public Class productoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddproductoRow(ByVal nombre As String, ByVal descripcion As String, ByVal stock As Decimal, ByVal precio_compra As Decimal, ByVal precio_venta As Decimal, ByVal fecha_vencimiento As Date, ByVal imagen() As Byte) As productoRow
            Dim rowproductoRow As productoRow = CType(Me.NewRow,productoRow)
            Dim columnValuesArray() As Object = New Object() {nombre, descripcion, stock, precio_compra, precio_venta, fecha_vencimiento, imagen}
...
Namespace dbventasDataSet2TableAdapters
    ...
    Partial Public Class productoTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT nombre, descripcion, stock, precio_compra, precio_venta, fecha_vencimiento"& _ 
                ", imagen FROM dbo.producto"
